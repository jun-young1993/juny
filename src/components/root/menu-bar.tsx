	...
	return (
		...
		>
			<Image
				...
				className='ml-3 transition delay-150 hover:-translate-y-3 hover:scale-110 hover:cursor-pointer duration-300 dark:bg-dlate-100'
				src={props.src}
				width={props.size}
				height={props.size}
				alt={props.menu}
	...
	return (
		<div className={"w-full h-full flex justify-center"}>
			...
			>
				...
				<MenuIcon size={imageSize} src={_IMAGE.BLOG} menu={MenuType.CALENDAR} />
				<GithubModal />
				<BlogModal />
			</div>
		</div>
